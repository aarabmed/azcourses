...
const Index =({menu})=>{
  ...
  return <>
            <Head>
                <title>Privacy Policy | AZcourses  </title>
            </Head>
            <Layout menu={menu}>
                <Grid container>
                    <Grid item xs={8} className="container az-privacy">
                        ...
                        <div className="az-privacy-pg">
                            ...
                            <p>
                                Azcourses.io (us, we, Non-Profit Organization) is committed to respecting the privacy rights of visitors and other users of this site. We created this Privacy Policy (this Policy) to give you confidence as you visit and use the Site, and to demonstrate our commitment to fair information practices. This Policy is only applicable to the Site, and not to any other websites that you may be able to access from the Site, each of which may have data collection and use practices and policies that differ materially from this Policy.
                            </p>
                        </div>
                        <div className="az-privacy-pg">
                        ...
                        <br/><br/>
                        <h1>INFORMATION COLLECTION PRACTICES</h1>
                        <div className="az-privacy-pg">
                            <h4>WHAT BASIC INFORMATION DOES THE WE COLLECT?</h4>
                            <p>
                                In operating the Site, we collect personal information from you if you contact us via the contact page. In doing so, you will provide us with your name and email address. You are not required to provide us with information to use and enjoy the Site.
                            </p>
                        </div>
                        <div className="az-privacy-pg">
                            <h4>WHAT BASIC INFORMATION DOES THE WE COLLECT?</h4>
                        ...
                        <br/><br/>
                        <h1>WEBSITE AREAS BEYOND OUR CONTROL</h1>
                        <div className="az-privacy-pg">
                        ...
                        <br/><br/>
                        <h1>CONTACT INFORMATION AND POLICY UPDATES</h1>
                        <div className="az-privacy-pg">
                            <h4>CONTACTING US</h4>
                            <p>
